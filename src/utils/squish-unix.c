...
int main(int argc __attribute__((unused)), char *argv[]) {
  ...
  if (bind(sock, (struct sockaddr *)&sun, (offsetof(struct sockaddr_un, sun_path) + strlen(sun.sun_path) + 1)) < 0) fail_io("bind");
  ...
  if (setitimer(ITIMER_VIRTUAL, &zero_itimerval, NULL) < 0) fail_io("setitimer");
